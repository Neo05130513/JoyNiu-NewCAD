...
from .schemas import BracketParameters, SplitClampSupportParameters
...
def _model_for(recipe_id: str) -> type[BracketParameters] | type[SplitClampSupportParameters]:
...
def parse_model_parameters(recipe_id: str, raw: Mapping[str, Any]) -> BracketParameters | SplitClampSupportParameters:
...
def validate_model_recipe(
    recipe_id: str,
    parameters: BracketParameters | SplitClampSupportParameters,
) -> dict[str, Any]:
